...
for l in samfile.fetch(until_eof=True):
	...
	if l.qname.split(" ")[0] in mel: #Not consistent with the dictionary key generation in lines 38 and 40 (should split at both)
		melout.write(l)
	elif l.qname.split(" ")[0]  in sim: #Same as above
		simout.write(l)
	else:
		missedout.write(l)
	c+=1
